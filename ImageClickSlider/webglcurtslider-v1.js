class Slider {
  ...
  doThings() {
    ...
    this.plane
      ...
      .onRender(() => {
        ...
        this.state.timer++; // Eased Timer Function, (I miss GSAP)
        /*******/ let tempTime = this.opt.easeType(
          this.state.steps * this.state.timer
        );
  ...
  autoplay() {
    ...
    let createTimer = setInterval(
      timer,
      that.opt.autoplayTimer + that.opt.duration
    );
  ...
  handleOptions(o) {
    ...
    let easings = {
      ...
      easeInOutQuad: (t) => (t < 0.5 ? 2 * t * t : -1 + (4 - 2 * t) * t), // 3
      easeInCubic: (t) => t * t * t, // 4
      easeOutCubic: (t) => --t * t * t + 1, // 5
      easeInOutCubic: (t) =>
        t < 0.5 ? 4 * t * t * t : (t - 1) * (2 * t - 2) * (2 * t - 2) + 1, // 6
      easeInQuart: (t) => t * t * t * t, // 7
      easeOutQuart: (t) => 1 - --t * t * t * t, // 8
      easeInOutQuart: (t) =>
        t < 0.5 ? 8 * t * t * t * t : 1 - 8 * --t * t * t * t, // 9
      easeInQuint: (t) => t * t * t * t * t, // 10
      easeOutQuint: (t) => 1 + --t * t * t * t * t, // 11
      easeInOutQuint: (t) =>
        t < 0.5 ? 16 * t * t * t * t * t : 1 + 16 * --t * t * t * t * t // 12
    };
    switch (o.easeType) {
      case 0:
        this.opt.easeType = easings.linear;
        break;
      case 1:
        this.opt.easeType = easings.easeInQuad;
        break;
      case 2:
        this.opt.easeType = easings.easeOutQuad;
        break;
      case 3:
        this.opt.easeType = easings.easeInOutQuad;
        break;
      case 4:
        this.opt.easeType = easings.easeInCubic;
        break;
      case 5:
        this.opt.easeType = easings.easeOutCubic;
        break;
      case 6:
        this.opt.easeType = easings.easeInOutCubic;
        break;
      case 7:
        this.opt.easeType = easings.easeInQuart;
        break;
      case 8:
        this.opt.easeType = easings.easeOutQuart;
        break;
      case 9:
        this.opt.easeType = easings.easeInOutQuart;
        break;
      case 10:
        this.opt.easeType = easings.easeInQuint;
        break;
      case 11:
        this.opt.easeType = easings.easeOutQuint;
        break;
      case 12:
        this.opt.easeType = easings.easeInOutQuint;
        break;
      default:
        this.opt.easeType = easings.linear;
    }
